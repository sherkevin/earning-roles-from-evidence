...
\begin{itemize}
  \item \textbf{Benchmark:} HotpotQA distractor validation subset, 200 examples (\fpath{artifacts/seed/hotpotqa_validation_200.jsonl}).
...
% Bibliography placeholders only --- replace with real references for camera-ready.
\nocite{Gusfield:97,Ando2005,andrew2007scalable,rasooli-tetrault-2015}
\bibliography{custom}
