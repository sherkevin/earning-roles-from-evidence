...
**R17 后所有可立即做的 ❌ / ⏳ 项均已 ✅**。本轮共 R13/R14/R15/R16/R17 5 个 commit 落地：S-104 (R-FULL-002 处理) + S-118 (Algorithm 1 v2) + S-124 (Appendix A → Limitations) + S-125/S-126/S-127/S-128 (honesty + checklist polish) + **R17 (U-018 → ✅ 加 MAD：派 E-015/E-016 + S-131 + external_baseline_plan §3.2/§4/§6 + PROJECT_STRUCTURE §0)**。下一轮启动条件：(a) engineer ack E-005 fullval done → S-115/S-116/S-117；(b) engineer ack E-012 swap done → S-121/S-122/S-123；(c) 用户出 Figure 1 → S-010；(d) **engineer ack E-015+E-016 (MAD reproduce + R2 swap into MAD) → S-131**；(e) engineer ack E-014 (gpt-4.1-mini Table 2 ablation) → 新 S-XXX 嵌 Table 2.b；(f) 新 reviewer batch 落盘 → S-104 再次触发。
