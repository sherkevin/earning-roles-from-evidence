...
ATTEMPT = os.environ.get('PAIR_FIXTURE_ATTEMPT','attempt_0001')
if not ATTEMPT.startswith('attempt_') or not ATTEMPT[8:].isdigit():
    raise ValueError('Invalid fixture attempt path')
OUT = (ROOT / 'artifacts/aamas2027/runtime_checks/'
       'peer_delivery_visibility_native_v1_20260923' / ATTEMPT)
...
def child(arm: str) -> None:
    ...
    native_name = 'pj_delivery_native_fixture_v1_' + ATTEMPT + '_' + arm
