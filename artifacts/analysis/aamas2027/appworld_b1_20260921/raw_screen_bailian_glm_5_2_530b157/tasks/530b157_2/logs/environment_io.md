...
```
{
 "access_token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJwaG9uZSs4OTAzNjY1NjM1IiwiZXhwIjoxNjg0NDEyMDU4fQ.Fo_DXcCEfknwhsBdZGJzNx-sYoBsL3E48J1EUV1DsIs",
 "token_type": "Bearer"
}
```
...
----------------------------------------------------------------------------
```python
contacts = apis.phone.search_contacts(access_token=phone_access_token, query="Joseph")
print(contacts)
```
...
----------------------------------------------------------------------------
```python
messages = apis.phone.search_text_messages(access_token=phone_access_token, phone_number="2233697879", query="grocery", page_limit=20)
print(messages)
```
...
page_index = 0
while True:
    page = apis.phone.search_text_messages(access_token=phone_access_token, phone_number="2233697879", page_index=page_index, page_limit=20, sort_by="+created_at")
    if page:
...
for msg in all_messages:
    print(f"[{msg['sent_at']}] {msg['sender']['name']}: {msg['message']}")
```

```
[2023-01-29T09:33:17] Joseph Weber: Hey, I am hosting a game night at my place this Friday. Would be great if you can join! Let me know.
[2023-01-29T10:10:03] Morgan Burton: Sorry, I have plans already. Maybe next time.
[2023-01-29T10:56:33] Joseph Weber: No worries. See you next time.
[2023-05-17T16:43:36] Morgan Burton: hey, how much was yesterday's grocery?
[2023-05-17T16:45:21] Joseph Weber: It was $98.
[2023-05-17T16:54:23] Morgan Burton: cool, I'll send it to you on venmo.
[2023-05-17T16:56:33] Joseph Weber: great, thanks!
[2023-05-18T17:19:01] Joseph Weber: how about we go to watch a movie next weekend?
[2023-05-18T17:24:40] Morgan Burton: sure, let's do it. That reminds me I owe you $37 from the last time.
[2023-05-18T17:29:43] Joseph Weber: Oh right, how about you pay this time, and we'll call it even?
[2023-05-18T17:39:20] Morgan Burton: sounds good.
```
...
```
{
 "access_token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ2ZW5tbyttb3JnYW4taGFycmlzb25AZ21haWwuY29tIiwiZXhwIjoxNjg0NDEyNjQ5fQ.5PJcc63sw8af9-SluZ9nizn5tsOebI1UjEPPlA7WPDQ",
 "token_type": "Bearer"
}
```
