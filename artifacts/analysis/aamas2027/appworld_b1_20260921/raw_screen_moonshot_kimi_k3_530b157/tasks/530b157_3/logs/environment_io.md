...
```
{
 "access_token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJwaG9uZSsyNzg2ODM3MDg4IiwiZXhwIjoxNjg0NDEyMTQ4fQ.YDMe2Kp68Rjj8HA5YY9PtVqRlhygcpYCjZPSOKHkVEk",
 "token_type": "Bearer"
}
```
...
robert_contacts = apis.phone.search_contacts(access_token=phone_token, query="Robert")
...
page_index = 0
while True:
    page = apis.phone.search_text_messages(access_token=phone_token, phone_number=robert_phone, page_index=page_index, page_limit=20)
    if page:
        ...
        break
for msg in messages:
    print(msg["sent_at"], msg["sender"]["name"], "->", msg["receiver"]["name"], ":", msg["message"])
```

```
2023-05-18T17:32:09 Jeremy Calhoun -> Robert Martinez : sounds good.
2023-05-18T17:23:15 Robert Martinez -> Jeremy Calhoun : Oh right, how about you pay this time, and we'll call it even?
2023-05-18T17:13:44 Jeremy Calhoun -> Robert Martinez : sure, let's do it. That reminds me I owe you $37 from the last time.
2023-05-18T17:11:08 Robert Martinez -> Jeremy Calhoun : how about we go to watch a movie next weekend?
2023-05-17T14:48:23 Robert Martinez -> Jeremy Calhoun : great, thanks!
2023-05-17T14:41:06 Jeremy Calhoun -> Robert Martinez : cool, I'll send it to you on venmo.
2023-05-17T14:32:34 Robert Martinez -> Jeremy Calhoun : It was $72.
2023-05-17T14:30:12 Jeremy Calhoun -> Robert Martinez : hey, how much was yesterday's grocery?
2023-05-13T08:54:17 Robert Martinez -> Jeremy Calhoun : You're welcome! I think you'll enjoy it.
2023-05-13T08:51:36 Jeremy Calhoun -> Robert Martinez : Absolutely! I love reading new books. Thanks for the offer.
2023-05-13T08:07:03 Robert Martinez -> Jeremy Calhoun : I just started reading a fascinating book. Would you like to borrow it when I'm done?
```
...
```
{
 "access_token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ2ZW5tbytqZXIuY2FsaG91bkBnbWFpbC5jb20iLCJleHAiOjE2ODQ0MTIzNDh9.p7qqG5RgfzetDZU1nfV3VnqcLwpoJnxCLxlKpcVq1jg",
 "token_type": "Bearer"
}
```
...
robert_venmo = apis.venmo.search_users(access_token=venmo_token, query="robertmartinez@gmail.com")
print(robert_venmo)
```
...
----------------------------------------------------------------------------
```python
transaction = apis.venmo.create_transaction(access_token=venmo_token, receiver_email="robertmartinez@gmail.com", amount=72, description="Thanks for the groceries!")
print(transaction)
```
...
----------------------------------------------------------------------------
```python
text_result = apis.phone.send_text_message(access_token=phone_token, phone_number="7195945426", message="Done. Thanks!")
print(text_result)
```
