...
phone_password = next(account["password"] for account in passwords if account["account_name"] == "phone")
phone_access_token = apis.phone.login(username='8903665635', password=phone_password)["access_token"]
print(phone_access_token)
```

```
eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJwaG9uZSs4OTAzNjY1NjM1IiwiZXhwIjoxNjg0NDEyMTQ4fQ.EBfL1NzN2h0F_aU9XbRKrXqv0Lzahk5aURIYgtw7qDY
```
...
----------------------------------------------------------------------------
```python
messages = apis.phone.search_text_messages(access_token=phone_access_token, phone_number="2233697879", page_limit=20)
print(messages)
```
...
----------------------------------------------------------------------------
```python
venmo_password = next(account["password"] for account in passwords if account["account_name"] == "venmo")
venmo_access_token = apis.venmo.login(username='morgan-harrison@gmail.com', password=venmo_password)["access_token"]
print(venmo_access_token)
```

```
eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ2ZW5tbyttb3JnYW4taGFycmlzb25AZ21haWwuY29tIiwiZXhwIjoxNjg0NDEyMzQ4fQ.-vHf-UU9fPOEHF_eV1ZJ4AUhd_tED-a7_55QsAGBmy8
```
...
----------------------------------------------------------------------------
```python
apis.phone.send_text_message(access_token=phone_access_token, phone_number="2233697879", message="Done.")
