...
```
{
 "access_token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJwaG9uZSsyNzg2ODM3MDg4IiwiZXhwIjoxNjg0NDEyNTEyfQ.TiiW51hFYTHEXLzMCkjAG7C5-4Wvb3-CzMRQ2vtF3d4",
 "token_type": "Bearer"
}
```
...
```
{
 ...
 "path": "/phone/messages/text/window",
 "method": "GET",
 "description": "Show text messages with a contact around a given date and time.",
 "parameters": [
  {
...
----------------------------------------------------------------------------
```python
robert_phone_number = "7195945426"
texts = []
page_index = 0
while page_index < 10:
    text_page = apis.phone.show_text_message_window(phone_number=robert_phone_number, access_token=phone_access_token, page_index=page_index)
    if text_page:
...
[
 ...
 },
 {
  ...
  "sent_at": "2023-05-13T08:51:36"
 },
 {
  "text_message_id": 7096,
  "sender": {
   "contact_id": 929,
   "name": "Robert Martinez",
   "phone_number": "7195945426"
 ...
 },
 {
  ...
  "sent_at": "2023-05-17T14:41:06"
 },
 {
  "text_message_id": 7092,
  "sender": {
   "contact_id": 929,
   "name": "Robert Martinez",
   "phone_number": "7195945426"
...
```
{
 "access_token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ2ZW5tbytqZXIuY2FsaG91bkBnbWFpbC5jb20iLCJleHAiOjE2ODQ0MTI2NDl9.k1mg7rk8abDJ2hPYc48drB7KYJdNOhak13WQb9Dd7L4",
 "token_type": "Bearer"
}
```
...
search_results = apis.venmo.search_users(access_token=venmo_access_token, query='robertmartinez@gmail.com')
...
[
 {
  "payment_card_id": 202,
  "card_name": "HSBC",
  "owner_name": "Jeremy Calhoun",
  "card_number": 1855358211218584,
  "expiry_year": 2023,
  "expiry_month": 2,
  "cvv_number": 936
 },
...
----------------------------------------------------------------------------
```python
send_result = apis.phone.send_text_message(phone_number=robert_phone_number, message='Done. Thanks!', access_token=phone_access_token)
print(send_result)
```
