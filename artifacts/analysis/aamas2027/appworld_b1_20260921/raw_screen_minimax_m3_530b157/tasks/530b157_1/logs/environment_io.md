...
phone_login_result = apis.phone.login(username='4886643554', password=phone_password)
...
----------------------------------------------------------------------------
```python
messages = apis.phone.search_text_messages(access_token=phone_access_token, phone_number='6017026518', page_limit=20)
print(messages)
```
...
```
{
 "access_token": "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJ2ZW5tbyttYXR0aGV3LmJsYWNAZ21haWwuY29tIiwiZXhwIjoxNjg0NDEyOTQzfQ.ERaGSlC6ghAv6L-iub7TrLoD1AbnK2-blECW3bRdM2U",
 "token_type": "Bearer"
}
```
...
----------------------------------------------------------------------------
```python
transaction_result = apis.venmo.create_transaction(access_token=venmo_access_token, receiver_email='kri-powe@gmail.com', amount=54, description='Groceries')
...
----------------------------------------------------------------------------
```python
send_text_result = apis.phone.send_text_message(access_token=phone_access_token, phone_number='6017026518', message='It is done.')
