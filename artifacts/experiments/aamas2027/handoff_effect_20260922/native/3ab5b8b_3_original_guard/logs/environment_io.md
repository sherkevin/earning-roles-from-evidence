...
```python
import json
target_song_ids = matched_albums[0]['song_ids']

_r2_semantic_targets = set(target_song_ids)
_r2_downloaded = []
...
```
{"semantic_targets": [47, 48, 49, 50, 51, 52, 53], "already_done": [55, 206, 293], "selected": [47, 48, 49, 50, 51, 52, 53], "excluded": []}
```
...
```
[47, 48, 49, 50, 51, 52, 53, 55, 206, 293]
True
```
