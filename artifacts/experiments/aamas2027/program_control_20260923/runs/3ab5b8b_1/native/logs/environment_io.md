...
_r3_source_rows = _r3_pages(apis.spotify.show_playlist_library)
_r3_liked_rows = _r3_pages(apis.spotify.show_liked_songs)
_r3_source = {sid for row in _r3_source_rows for sid in (row['song_ids'] if 'song_ids' == 'song_ids' else [row['song_ids']])}
...
```
{"target": [2, 11, 14, 27, 48, 94, 99, 119, 131, 147, 173, 182, 190, 192, 197, 229, 233, 235, 251, 289, 303, 324], "done": [15, 99, 135], "selected": [2, 11, 14, 27, 48, 94, 119, 131, 147, 173, 182, 190, 192, 197, 229, 233, 235, 251, 289, 303, 324]}
```
